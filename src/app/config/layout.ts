...
export class LayoutConfig implements ConfigModel {
	public config: any = {
		demo: 'default',
//Assets located here: './assets/app/media/img/logos/xxx.png'
		// == Base Layout
		self: {
		...
		loader: {
			...
			image: './assets/app/media/img/logos/hci-logo-small.png'
		},
		...
		header: {
			...
			self: {
				...
				logo: {
					dark: './assets/app/media/img/logos/hci-logo-small.png',
					light: './assets/app/media/img/logos/hci-logo-small.png'
				}
			},
